...
const programs = [
  ...
  { label: 'Admission Process', path: '/contact' },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="https://wa.me/919709908168" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-cream/10 flex items-center justify-center hover:bg-burnt transition-colors">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+919709908168" className="text-cream/70 text-sm hover:text-cream transition-colors">
                  +91 97099 08168
                </a>
              </div>
              <div className="flex items-center gap-3">
