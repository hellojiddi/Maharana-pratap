      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-ivory rounded-2xl p-8 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            <p className="text-burnt font-body font-medium mb-1">+91 97099 08168</p>
          ...
          <div className="bg-ivory rounded-2xl p-8 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            <a href="tel:+919709908168" className="text-burnt font-body font-medium block mb-1">+91 97099 08168</a>
            ...
            <a href="tel:+919709908168" className="btn-primary w-full block text-center">
              Call Now
            </a>
          </div>
          ...
          <div>
            ...
            <div className="bg-ivory rounded-2xl p-7 shadow-sm mb-6">
              ...
              <div className="space-y-3 mb-4">
                <a href="tel:+919709908168" className="flex items-center gap-2 text-navy text-sm font-body">
                  <Phone size={15} className="text-burnt" /> +91 97099 08168
                </a>
